...
func (e UserEdges) MealplanOrErr() ([]*Mealplan, error) {
	if e.loadedTypes[0] {
...
// was not loaded in eager-loading.
func (e UserEdges) FoodmenuOrErr() ([]*Foodmenu, error) {
	if e.loadedTypes[1] {
...
// was not loaded in eager-loading.
func (e UserEdges) EatinghistoryOrErr() ([]*Eatinghistory, error) {
	if e.loadedTypes[2] {
...
// QueryMealplan queries the mealplan edge of the User.
func (u *User) QueryMealplan() *MealplanQuery {
	return (&UserClient{config: u.config}).QueryMealplan(u)
}

// QueryFoodmenu queries the foodmenu edge of the User.
func (u *User) QueryFoodmenu() *FoodmenuQuery {
	return (&UserClient{config: u.config}).QueryFoodmenu(u)
}

// QueryEatinghistory queries the eatinghistory edge of the User.
func (u *User) QueryEatinghistory() *EatinghistoryQuery {
	return (&UserClient{config: u.config}).QueryEatinghistory(u)
}
